...
def complete():
    ...
    return render_template('complete.html', attraction_price=current_app.config['attraction_price'], hotel_price = current_app.config['hotel_price'], air_price = current_app.config['air_price'], total_price = total_price, count_people=current_app.config['count_people'])